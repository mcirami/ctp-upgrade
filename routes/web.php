...
Route::group(['middleware' => 'legacy.auth' ], function () {
	...
	Route::get('/two-factor/enroll', [TwoFactorController::class, 'enroll'])->name('2fa.enroll');
	Route::post('/two-factor/enroll/start', [TwoFactorController::class, 'startEnroll'])->name('2fa.enroll.start');
	Route::post('/two-factor/enroll/confirm', [TwoFactorController::class, 'confirmEnroll'])->name('2fa.enroll.confirm');
	Route::get('/two-factor/challenge', [TwoFactorController::class, 'challenge'])->name('2fa.challenge')->middleware('throttle:10,1');
	Route::post('/two-factor/challenge', [TwoFactorController::class, 'verifyChallenge'])->name('2fa.challenge.verify');
	...
	Route::group(['middleware' => '2fa' ], function () {
		...
		Route::group( [ 'prefix' => 'user' ], function () {
			...
			Route::post( '/change-aff-payout',
				[ UserController::class, 'changeAffPayout' ] )->middleware( [ 'role:0' ] );
			Route::post( '/update-offer-access',
				[ UserController::class, 'updateAffOfferAccess' ] )->middleware( [ 'role:0' ] );
			Route::get( '/offers/{user}', [ UserController::class, 'editUserOffers' ] )->middleware( [ 'role:0' ] );
			Route::post( '/enable-user-offer-cap',
				[ UserController::class, 'enableUserOfferCap' ] )->middleware( [ 'role:0' ] );
			Route::post( '/set-user-offer-cap',
				[ UserController::class, 'setUserOfferCap' ] )->middleware( [ 'role:0' ] );
			...
			Route::get( '{id}/clicks',
				[ ClickReportController::class, 'showUsersClicks' ] )->middleware( 'role:0,1,2' )->name( 'userClicks' );
			Route::get( '{id}/clicks/export', [
				ExportDataController::class,
				'exportUsersClicks'
			] )->middleware( 'role:0,1,2' )->name( 'exportUserClicks' );
			Route::get( '{id}/search-clicks',
				[ ClickReportController::class, 'searchClicks' ] )->middleware( 'role:0' )->name( 'clicks.search' );

			Route::get( '{id}/conversions-by-offer', [
				ConversionReportController::class,
				'showUserConversionsByOffer'
			] )->middleware( 'role:0,1,2' )->name( 'userConversionsByOffer' );
			Route::get( '{id}/conversions', [
				ConversionReportController::class,
				'showUserConversions'
			] )->middleware( 'role:0,1,2' )->name( 'userConversions' );
			Route::get( '{user}/{offer}/conversions-by-country', [
				ConversionReportController::class,
				'showUserOfferConversionsByCountry'
			] )->middleware( 'role:0,1,2,3' )->name( 'userOfferConversionsByCountry' );
			Route::get( '{user}/{offer}/conversions-by-subid', [
				SubReportController::class,
				'showUserConversionsBySubId'
			] )->middleware( 'role:0,1,2' )->name( 'userConversionsBySubId' );
			Route::get( '{user}/{offer}/subid-clicks-by-offer', [
				SubReportController::class,
				'showSubIdClicksByOffer'
			] )->middleware( 'role:0,1,2' )->name( 'subIdClicksByOffer' );
			Route::get( '{user}/{offer}/subid-conversions-in-country', [
				SubReportController::class,
				'showSubIdConversionsInCountry'
			] )->middleware( 'role:0,1,2' )->name( 'subIdConversionsInCountry' );
			Route::get( '{user}/{offer}/subid-offer-clicks-in-country', [
				SubReportController::class,
				'showSubIdClicksByOfferInCountry'
			] )->middleware( 'role:0,1,2' )->name( 'subIdClicksByOfferInCountry' );
			Route::get( '{user}/{offer}/subid-offer-conversions-by-country', [
				SubReportController::class,
				'subIdOfferConverisonsByCountry'
			] )->middleware( 'role:0,1,2' )->name( 'subIdOfferConverisonsByCountry' );
		} );
		Route::group( [ 'prefix' => 'report' ], function () {
			Route::get( 'daily', [ AggregateReportController::class, 'show' ] );
			Route::get( 'geo',
				[ ConversionReportController::class, 'showConversionsByCountry' ] )->middleware( 'role:0,1' );
			Route::get( 'geo-by-offer',
				[ ConversionReportController::class, 'showGeoByOffer' ] )->middleware( 'role:0,1' );
			Route::get( 'geo/clicks-in-country',
				[ ClickReportController::class, 'clicksInCountry' ] )->middleware( 'role:0,1' );
			Route::get( 'geo/clicks-in-country/export',
				[ ExportDataController::class, 'exportCountryClicks' ] )->middleware( 'role:0,1' );
			Route::get( 'offer', [ OfferReportController::class, 'show' ] );
			Route::get( 'offer-data/export', [
				ExportDataController::class,
				'exportOfferData'
			] )->middleware( 'role:0,1' )->name( 'exportOfferData' );
			Route::get( 'offer/{offer}/user-conversions', [ OfferReportController::class, 'showConversionsByUser' ] );
			Route::get( 'offer/{offer}/conversions-by-country',
				[ OfferReportController::class, 'showConversionsByCountry' ] );

			Route::get( 'manager/{user}/conversions-by-offer',
				[ ConversionReportController::class, 'showManagerConversionsByOffer' ] );
			...
			Route::get( 'advertiser/{id}/conversions-by-offer',
				[ AdvertiserReportController::class, 'showConversionsByOffer' ] )
			     ->middleware( [ 'permissions:' . Permissions::VIEW_ADV_REPORTS, 'role:0,1' ] );
			...
			Route::get( 'aff-data/export',
				[ ExportDataController::class, 'exportAffData' ] )->middleware( 'role:0,1' )->name( 'exportAffData' );
		...
		Route::group( [ 'prefix' => 'offer' ], function () {
			...
			Route::get( '{id}/clicks',
				[ ClickReportController::class, 'offerClicks' ] )->middleware( 'role:0,1,2' )->name( 'offerClicks' );
			Route::get( '{id}/search-clicks', [
				ClickReportController::class,
				'searchClicks'
			] )->middleware( 'role:0' )->name( 'offer.clicks.search' );
		...
		Route::group( [ 'prefix' => 'email/pools', 'middleware' => "permissions:" . Permissions::EMAIL_POOLS ],
			function () {
		...
		Route::group( [ 'prefix' => 'sms' ], function () {
			Route::group( [ 'prefix' => 'api' ], function () {
				...
				Route::patch( 'conversations/{conversationId}/read-new-messages',
					[ SmsApiController::class, 'readNewMessages' ] );
			} );
			Route::get( '/',
				[ SmsController::class, 'getChattingPage' ] )->middleware( [ 'role:' . Privilege::ROLE_AFFILIATE ] );
