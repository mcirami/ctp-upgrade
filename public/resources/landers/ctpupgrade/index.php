...
<html lang="en">
					...
					<nav class="navbar navbar-expand-lg">
						<div class="container-fluid">
							<a class="navbar-brand" href="/">
								<img src="/resources/landers/ctpupgrade/images/logo.png" alt="">
							</a>
				...
				<section class="splide" aria-label="Splide Basic HTML Example">
					<div class="splide__track">
						<ul class="splide__list">
							...
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 32 32"><path fill="#f8dc51" d="M10 4H22V28H10z"></path><path d="M5,4h6V28H5c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z"></path><path d="M25,4h6V28h-6c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" transform="rotate(180 26 16)" fill="#dd4446"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">BE</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 32 32"><rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#ac2431"></rect><path fill="#fff" d="M31 12L17 12 17 4 9 4 9 12 1 12 1 20 9 20 9 28 17 28 17 20 31 20 31 12z"></path><path fill="#061a57" d="M31 14L15 14 15 4 11 4 11 14 1 14 1 18 11 18 11 28 15 28 15 18 31 18 31 14z"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">NO</p>
							</li>
							<li class="splide__slide">
							...
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path fill="#fff" d="M10 4H22V28H10z"></path><path d="M5,4h6V28H5c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" fill="#41914d"></path><path d="M25,4h6V28h-6c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" transform="rotate(180 26 16)" fill="#bf393b"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">IT</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#fff"></rect><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><circle cx="16" cy="16" r="6" fill="#ae232f"></circle><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">JP</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#2e69a4"></rect><path fill="#f7cf46" d="M31 14L15 14 15 4 11 4 11 14 1 14 1 18 11 18 11 28 15 28 15 18 31 18 31 14z"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">SE</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M1,24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V15H1v9Z" fill="#fff"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4v8H31V8c0-2.209-1.791-4-4-4Z" fill="#db3c3f"></path><path d="M5,28H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4ZM2,8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path><path d="M6.811,10.5c0-1.898,1.321-3.487,3.094-3.897-.291-.067-.594-.103-.906-.103-2.209,0-4,1.791-4,4s1.791,4,4,4c.311,0,.615-.036,.906-.103-1.773-.41-3.094-1.999-3.094-3.897Z" fill="#fff"></path><path fill="#fff" d="M10.81 8.329L10.576 9.048 11.189 8.603 11.801 9.048 11.567 8.329 12.179 7.884 11.423 7.884 11.189 7.164 10.955 7.884 10.198 7.884 10.81 8.329z"></path><path fill="#fff" d="M14.361 9.469L13.605 9.469 13.371 8.749 13.137 9.469 12.38 9.469 12.992 9.914 12.759 10.634 13.371 10.189 13.983 10.634 13.749 9.914 14.361 9.469z"></path><path fill="#fff" d="M10.074 12.034L9.84 11.315 9.606 12.034 8.85 12.034 9.462 12.479 9.228 13.199 9.84 12.754 10.452 13.199 10.218 12.479 10.831 12.034 10.074 12.034z"></path><path fill="#fff" d="M12.771 12.034L12.537 11.315 12.303 12.034 11.547 12.034 12.159 12.479 11.925 13.199 12.537 12.754 13.149 13.199 12.916 12.479 13.528 12.034 12.771 12.034z"></path><path fill="#fff" d="M9.24 9.469L9.007 8.75 8.773 9.469 8.016 9.469 8.628 9.914 8.394 10.634 9.007 10.189 9.619 10.634 9.385 9.914 9.997 9.469 9.24 9.469z"></path></svg>
								<p class="title">SG</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M1,24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V15H1v9Z" fill="#c62d25"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4v8H31V8c0-2.209-1.791-4-4-4Z" fill="#fff"></path><path d="M2.316,26.947l13.684-10.947L2.316,5.053c-.803,.732-1.316,1.776-1.316,2.947V24c0,1.172,.513,2.216,1.316,2.947Z" fill="#1e427b"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">CZ</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#fff"></rect><path fill="#0e2a69" d="M31 14L15 14 15 4 11 4 11 14 1 14 1 18 11 18 11 28 15 28 15 18 31 18 31 14z"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path></svg>
								<p class="title">FI</p>
							</li>
							<li class="splide__slide">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#e93323"></rect><path d="M5,4H16v12H1V8c0-2.208,1.792-4,4-4Z" fill="#020090"></path><path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path><path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path><path d="M6.664,8.859l-1.953-.523,1.429,1.429c.109-.339,.29-.647,.524-.906Z" fill="#fff"></path><path d="M8.5,8.044c.179,0,.354,.02,.523,.056l-.523-1.952-.523,1.952c.169-.036,.344-.056,.523-.056Z" fill="#fff"></path><path d="M7.741,8.163l-1.429-1.429,.523,1.953c.258-.234,.566-.415,.906-.524Z" fill="#fff"></path><path d="M10.164,8.687l.523-1.953-1.429,1.429c.339,.109,.647,.29,.906,.524Z" fill="#fff"></path><path d="M10.86,9.764l1.429-1.429-1.953,.523c.234,.258,.415,.566,.524,.906Z" fill="#fff"></path><circle cx="8.5" cy="10.523" r="2.188" fill="#fff"></circle><path d="M12.875,10.523l-1.952-.523c.036,.169,.056,.344,.056,.523s-.02,.354-.056,.523l1.952-.523Z" fill="#fff"></path><path d="M9.259,12.883l1.429,1.429-.523-1.953c-.258,.234-.566,.415-.906,.524Z" fill="#fff"></path><path d="M10.336,12.187l1.953,.523-1.429-1.429c-.109,.339-.29,.647-.524,.906Z" fill="#fff"></path><path d="M8.5,13.002c-.179,0-.354-.02-.523-.056l.523,1.952,.523-1.952c-.169,.036-.344,.056-.523,.056Z" fill="#fff"></path><path d="M6.836,12.359l-.523,1.953,1.429-1.429c-.339-.109-.647-.29-.906-.524Z" fill="#fff"></path><path d="M6.14,11.282l-1.429,1.429,1.953-.523c-.234-.258-.415-.566-.524-.906Z" fill="#fff"></path><path d="M6.021,10.523c0-.179,.02-.354,.056-.523l-1.952,.523,1.952,.523c-.036-.169-.056-.344-.056-.523Z" fill="#fff"></path></svg>
								<p class="title">TW</p>
							</li>
							<li class="splide__slide">
	...
	<section id="our_benefits">
		<div class="container">
			<h3>Models work hard, we provide the easy button</h3>
			<p>Models spend a lot of time and effort to grow their audiences. The work takes constant attention and endless effort. Model.cash is here to provide a very simple, "set it and forget it" option for earning extra cash for the traffic you generate. Our leadership team boasts over 50 years combined experience in marketing and revenue growth for influencers and we are excited to offer a game-changing experience to boost revenue in the most simple way possible.</p>
		</div>
	</section>
	<section id="how_it_works">
		<div class="container">
			<div class="two_columns">
				<div class="column">
					<img src="/resources/landers/ctpupgrade/images/home-graph.png" alt="">
				</div>
				<div class="column">
					<small>MODELS</small>
					<h3>All it takes is one button and our universal SmartLink</h3>
			...
			<div id="tabs" class="tab_section">
				<h3>model.cash opportunities and features</h3>
				<p>Capitalize on your growing audience with a simple, passive income opportunity to add into your links.</p>
				<div class="tab_wrap">
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item">
							<button class="nav-link active" data-bs-toggle="tab" id="pills-smartlink-tab" data-bs-target="#pills-smartlink" role="tab" aria-controls="pills-smartlink" aria-selected="true">SmartLink</button>
						</li>
						<li class="nav-item">
							<button class="nav-link" data-bs-toggle="tab" id="pills-engagement-tab" data-bs-target="#pills-engagement" role="tab" aria-controls="pills-engagement" aria-selected="false">Engagement</button>
						</li>
						<li class="nav-item">
							<button class="nav-link" data-bs-toggle="tab" data-bs-toggle="tab" id="pills-recruiting-tab" data-bs-target="#pills-recruiting" role="tab" aria-controls="pills-recruiting" aria-selected="false">Recruiting</button>
						</li>
						<li class="nav-item">
							<button class="nav-link" data-bs-toggle="tab" id="pills-tracking-tab" data-bs-target="#pills-tracking" role="tab" aria-controls="pills-tracking" aria-selected="false">Tracking</button>
						</li>
						<li class="nav-item">
							<button class="nav-link" data-bs-toggle="tab" id="pills-payments-tab" data-bs-target="#pills-payments" role="tab" aria-controls="pills-payments" aria-selected="false">Payments</button>
						</li>
					</ul>
					<div class="tab-content" id="pills-tabContent">
						...
						<div class="tab-pane fade" id="pills-recruiting" role="tabpanel" aria-labelledby="pills-recruiting-tab">
							<h3>Recruiting</h3>
							<p>
								After getting started and getting paid, any model looking to increase cash even more can become a Model Ambassador. A Model Ambassador can be setup to recruit other models for a share in the profits from each sale any model you recruit earns for life!
							</p>
						</div>
