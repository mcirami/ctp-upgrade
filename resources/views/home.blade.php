    ...
    <div class = "right_panel member_home">
        ...
        <div class = "white_box_outer">
            ...
            <div class = "white_box value_span8">
                ...
                <div class = "com_acc">
                    <p><span class = "lft value_span9">Name</span><span class = "rt value_span10">{{$firstName}} {{$lastName}}</span></p>
                    <p><span class = "lft value_span9">Username</span><span class = "rt value_span10">{{$username}}</span></p>
