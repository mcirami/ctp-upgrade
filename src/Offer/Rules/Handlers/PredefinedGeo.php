...
class PredefinedGeo
{
    ...
    public static function createFromGeoPostData(int $userID, string $name, array $geoPostData): int
    {
        ...
        $redirectOffer = !empty($geoPostData[2]) ? (int)$geoPostData[2] : null;
        ...
        try {
            ...
            if ($presetID > 0) {
                ...
                $sql = "INSERT INTO predefined_geo_rules
                            (rep_idrep, name, redirect_offer, deny, is_active, created_at, updated_at)
    ...
    public static function createFromRuleDataAndCountryList(
        int $userID,
        string $name,
        $ruleData,
        array $countryList
    ...
    private static function replaceCountries($db, int $presetID, array $countries): void
    {
        ...
        $countrySql = "INSERT INTO predefined_geo_rule_countries
                           (predefined_geo_rule_id, country_code, country_name, cap_status, cap, created_at, updated_at)
